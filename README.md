...
```bash
git clone https://github.com/hemant25bai11276-dot/Hospital-Management-System.git
```
...
```text
File → Open → Hospital-Management-System
```

### 3. Configure JDK

Make sure a suitable **JDK** is installed and selected in IntelliJ IDEA.
...
| --------- | ------------------------------- | -------------------------------------------- |
| 1         | Start the application           | Application runs successfully                |
| 2         | Enter valid patient information | Patient information is accepted              |
| 3         | Enter doctor information        | Doctor information is stored/displayed       |
| 4         | Create an appointment           | Appointment information is processed         |
| 5         | Enter invalid/empty input       | Appropriate validation or error is displayed |
